...
<div class="content">
  ...
  <li>Interface:Hikaru Chang(i@rua.moe)</li>
	<li>udp2raw tunnel，通过raw socket给UDP包加上TCP或ICMP header，进而绕过UDP屏蔽或QoS，或在UDP不稳定的环境下提升稳定性。可以有效防止在使用kcptun或者finalspeed的情况下udp端口被运营商限速。</li>
	<li>支持心跳保活、自动重连，重连后会恢复上次连接，在底层掉线的情况下可以保持上层不掉线。同时有加密、防重放攻击、信道复用的功能。</li>
  ...
  <li>关于本插件的BUG反馈以及建议：<a href="https://github.com/hikaruchang/udp2raw-koolsoft" target="_blank"><u>Github</u></a> | <a href="mailto:i@rua.moe" target="_blank"><u>Email</u></a></li>
</div>
</div>
